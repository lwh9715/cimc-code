	...
	<view>
		...
		<view class="">
			<block v-for="(item,index) in list" :key="index">
				<view @click="notAvail(index)" class="u-f u-f-jsb" style="margin: 15rpx 50rpx;border-bottom: 1px solid #eee;padding-bottom: 20rpx; ">
					<view class="u-f">
			...
			<view @click="changeLang" class="u-f u-f-jsb" style="margin: 15rpx 50rpx;border-bottom: 1px solid #eee;padding-bottom: 20rpx; ">
				<view class="u-f" >
				...
				<u-popup v-model="showPop"  mode="bottom" border-radius="20">
						<view  class="px-3">
							<view class="flex justify-between align-center">
								...
								<text @click="showPop = false" class="iconfont icon-reeor  " style="font-size: 56rpx;color: #6DBA52;"></text>
							</view>
							
							<view class="flex justify-center align-center">								
								<text class="iconfont icon-unlock mr-2 " style="font-size: 56rpx;color: #6DBA52;"></text>
								<input type="text" v-model="pwd.userpwd" placeholder="请输入原密码" class="border-bottom" style="border-color: #6DBA52;" value="" />
							</view>
							<view class="flex justify-center align-center">
								<text class="iconfont icon-password1  mr-2 " style="font-size: 56rpx;color: #6DBA52;"></text>
								<input type="text"  v-model="pwd.newciphertext" placeholder="请输入新密码" class="border-bottom" style="border-color: #6DBA52;" value="" />
							</view>
							<view class="flex justify-center align-center">
								<text class="iconfont icon-password1  mr-2 " style="font-size: 56rpx;color: #6DBA52;"></text>
								<input type="text"  v-model="pwd.newsecretkey" placeholder="请再次输入新密码" class="border-bottom" style="border-color: #6DBA52;" value="" />
							</view>							
