<template>
	<view>
		<!-- <view class="pagenation flex justify-center">
			...
			<view class=" flex justify-center">
				...
				<picker v-if="zpage > 3" class="" mode="selector"  :range="selector" @change="changePage">
					<view class="flex justify-center">
						<text  class="btn">{{curentPage}}/{{zpage}}</text>
						<text class="btn ">跳页</text>
					</view>
				</picker>
		...
		<page-three @getPage="getPage" class="mt-3" :total="120"></page-three>
		<page-five  @getPage="getPage" class="mt-3" :total="120"></page-five>
			{{cp}}
	</view>
</template>
